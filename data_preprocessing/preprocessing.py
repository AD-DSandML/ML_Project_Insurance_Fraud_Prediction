...
class Preprocessor:
    ...
    def impute_missing_values(self, data, cols_with_missing_values):
        ...
        try:
            ...
            for col in self.cols_with_missing_values:
                ...
                self.data[col] = self.data[col].fillna('others')
    ...
    def encode_categorical_columns(self,data):
        ...
        try:
            ...
            self.cat_df['property_damage'] = self.cat_df['property_damage'].map({'NO': 0, 'YES': 1,'others': 2})
            self.cat_df['police_report_available'] = self.cat_df['police_report_available'].map({'NO': 0, 'YES': 1,'others': 2})
            try:
